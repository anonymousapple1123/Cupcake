...
void extract_and_save_response(const std::string &json_file_path,
  ...
  try {
    ...
    std::cerr << "Failed to extract the main response: " << e.what()
              << std::endl;
    return;
  }
...
//     extract_and_save_response("../codex_res/model_output.json",
