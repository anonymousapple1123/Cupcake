...
def check_requirements():
    ...
    requirements = {
        ...
        "cmake": ["cmake", "--version"],
        "c++_compiler": ["g++" if platform.system() != "Windows" else "cl", "--version"]
...
def test_installation():
    ...
    try:
        ...
        print("  C++ performance module not available (will use Python fallback)")
    except Exception as e:
        print(f"  C++ performance module error: {e}")
